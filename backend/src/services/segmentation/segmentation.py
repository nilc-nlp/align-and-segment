...
def apply_segmentation(concatenate_files, textgrids_list, locs_files_list, file_name, path):
    ...
    class AutomaticSegmentation:
        ...
        def find_boundaries(self, locs_file, tg_file, output_tg_file, window_size, delta1, delta2, silence_threshold, interval_size, min_words_h2):        
        ...
        def metrics(self, annot_tg, method_tg, timestamps_silences, timestamps_dsrs_1, timestamps_dsrs_2, hits_threshold, metrics_path):
    ...
    # FALTA ARRUMAR OS NOMES E CAMINHOS, PERSONALIZAR PRO CASO DA INTERFACE
    segments_quantity = len(textgrids_list)
